	...
	return (
		<VStack maxH="100vh" as="aside" p="6" align="flex-start">
			<VStack align="flex-start" mb="auto">
				<Header />
				<Button as={NextLink} href={'/all-shows'} fontSize="2xl" mb="4" fontWeight="light" color="white" variant="link">
					All shows
				</Button>
				<Button as={NextLink} href={'/top-rated'} fontSize="2xl" mb="4" fontWeight="light" color="white" variant="link">
					Top rated
				</Button>
